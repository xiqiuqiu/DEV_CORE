...
export const projects: Project[] = [
  {
    ...
    title: "KK工具箱 - 蜂巢术搜",
    description:
      '专门为专业翻译人员设计的术语高速检索工具。通过"蜂巢"架构提供海量术语库的秒级查询，帮助译者在翻译过程中快速获取精准的行业词汇。',
  ...
  },
  {
    ...
    description:
      "易解（YiTran）的综合翻译解决方案平台。提供翻译项目管理（TMS）、在线协作翻译环境以及术语库管理，旨在简化翻译工作流并提高团队协作效率。",
  ...
  },
  {
    ...
    title: "LegalEagle AI",
    description:
      "基于人工智能的法律辅助工具。利用大语言模型（LLM）协助法律专业人士进行法律文献检索、合同/文档自动分析及法律咨询建议，提高法律工作的自动化水平。",
  ...
  },
  {
    id: 5,
    title: "Excel关键词搜索工具",
    description: "一个简单易用的Excel文件关键词搜索工具，支持批量搜索多个Excel文件中的关键词，并提供直观的GUI界面。",
